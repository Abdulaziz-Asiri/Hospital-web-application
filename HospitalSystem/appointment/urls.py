...
urlpatterns = [
    ...
    path("all-doctor-Appointment/", views.all_doctor_appointment_view, name="all_doctor_appointment_view"),
    ...
    path("deleteAppointment/<appointment_id>", views.delete_appointment_view, name="delete_appointment_view"),
]